        ...
        implements View.OnClickListener
{
    ...
    private void findViews()
    {
       /* resultTxtView = (TextView) findViewById(R.id.resultTxtView);
        ...
        resultTxtView = (TextView) findViewById(getResources().getIdentifier
                (ReflexHelper.getInstance().getString(this,1), ReflexHelper.getInstance().getString(this,2), getPackageName()));
        inputTxtView = (EditText) findViewById(getResources().getIdentifier
                (ReflexHelper.getInstance().getString(this,3), ReflexHelper.getInstance().getString(this,4), getPackageName()));
